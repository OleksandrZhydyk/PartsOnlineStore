...
from api.views import (ModelDeleteView, ModelRetrieveView,
                       ModelUpdateView, PartDeleteView,
                       PartRetrieveView, PartUpdateView, ProfileUserView,
                       UserViewSet, PartListView, PartCreateView, ModelCreateView, ModelListView, ShopListView,
                       ShopRetrieveUpdateDeleteView)
...
urlpatterns = [
    ...
    path("part/create/", PartCreateView.as_view()),
    ...
    path("model/create/", ModelCreateView.as_view()),
